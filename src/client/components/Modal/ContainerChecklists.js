    ...
    return (
        <div className="row" id="containerChecklist">
            ...
            <div className="col-lg-12 checklistTarefa" data-idchecklist="124">
                ...
                <h4>
                    <b>Atividades</b>
                    <input type="text" className="form-control hide" defaultValue="Atividades"/>
                    <small>
                ...
                <small className="tarefasCompletadas" data-total="1" data-concluido="0">0/1 tarefas completadas | 0,00%</small>
                ...
                <div className="containerItensChecklist">
                    <div className="checkbox">
                        ...
                        <span className="text-uppercase">Organizar projetos em excução</span>
                        &nbsp;&nbsp;<a href="#453" className="text-danger">remover</a>
                    </div>
                </div>
                <div className="inputNovoItemChecklist hide">
                    <p><input type="text" placeholder="nome do item"/></p>
                </div>

                <p>
                    <a href="#" className="adicionarItem">+ adicionar item</a>
                </p>
            </div>
        </div>
    );
