    ...
    <div>
      ...
      <span id="containerDataTarefa">
        <span>
          <a
            href="#"
            id="btnMostrarDatepicker"
            className="hide btn btn-sm btn-primary"
          >
          ...
          <span id="datePickerDataTarefa" className="hide">
            ...
            />
            <button id="btnDefinirData" className="btn btn-success btn-sm">
              OK
            </button>
          </span>
          <span className="" id="dataSelecionada">
            <span className="badge badge-success">
              <input type="checkbox" />
              <span title="Clique para alterar a data" id="dataTarefa">
                14/08/2017
              </span>
            </span>
            <button
