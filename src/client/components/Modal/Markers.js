  ...
  return (
    <div className="col-lg-6 col-md-6">
      ...
      <div className="form-group form-inline hide" id="formMarcador">
          ...
          <ul className="dropdown-menu" role="menu">
            <li>
              <a
                ...
                className="btn btn-success btn-block btnMarcador"
              >
                <br />
              </a>
            </li>
            <li>
              <a
                ...
                className="btn btn-warning btn-block btnMarcador"
              >
                disrcunstancial
              </a>
            </li>
            <li>
              <a
                ...
                className="btn btn-danger btn-block btnMarcador"
              >
                urgente
              </a>
            </li>
            <li>
              <a
                ...
                className="btn btn-blue btn-block btnMarcador"
              >
                importante
              </a>
            </li>
        ...
        <button id="btnAdicionarMarcador" className="btn ">
          Adicionar
          <span className="fa fa-tag" />
        </button>
      </div>
